...
class CreateProductListScreen extends StatefulWidget {
  const CreateProductListScreen({super.key});

  @override
  _CreateProductListScreenState createState() =>
      _CreateProductListScreenState();
}

class _CreateProductListScreenState extends State<CreateProductListScreen> {
